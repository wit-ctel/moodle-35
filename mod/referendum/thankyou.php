...
$PAGE->set_url('/mod/referendum/thankyou.php', array('id' => $cm->id));
$PAGE->set_title(format_string($strreferendum));
$PAGE->set_heading(format_string($strreferendum));
...
echo html_writer::tag('h3', get_string('thankyou', 'mod_referendum'));
$returnurl = new moodle_url('/course/view.php', array('id' => $course->id));
echo html_writer::link($returnurl, get_string('returntocourse', 'mod_referendum'), array('class' => 'btn btn-default'));
