                    ...
                    for ($x = 0; $x < $innernodelist->length; $x++) {
                        ...
                        if ($innernodelist->item($x)->hasAttributes()) {
                            ...
                            if (!is_null($domnode)) {
                                ...
                                // Check if the SCO item is a recording or uploaded document.  We only want to display recordings. Recordings are identified as 'icon' attribute of value 'archive' in <sco> element.  
